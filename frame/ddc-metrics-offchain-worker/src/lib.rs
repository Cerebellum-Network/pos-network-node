...
use pallet_contracts::Config as SysConfig;
...
impl<T: Config> Module<T> {
    ...
    fn sc_get_current_period_ms(
        ...
        let (exec_result, _gas_consumed) = pallet_contracts::Pallet::<T::CT>::bare_call(
            Default::default(),
            contract_id,
            0u32.into(),
            100_000_000_000,
...
pub trait Config: frame_system::Config 
    where 
    <<Self as Config>::CT as Config>::AccountId: AsRef<[u8]>,
        {
